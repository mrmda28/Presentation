...
class Git(QWidget):
    ...
    def init_ui(self):
        ...
        self.lbl.setStyleSheet('font-size: 36px; color: white; background: transparent;')
        ...
        self.btn_git.setText('Открыть GitHub репозиторий')
        self.btn_git.setStyleSheet('font-size: 24px; color: white; border: none; border-bottom: 3px solid yellow; background: transparent;')
